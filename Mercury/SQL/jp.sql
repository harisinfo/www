...
-- Dumping structure for table jp.condition_product
DROP TABLE IF EXISTS `condition_product`;
CREATE TABLE IF NOT EXISTS `condition_product` (
  `condition_product_id` int(50) NOT NULL AUTO_INCREMENT,
  `product_group_id` int(10) DEFAULT '0',
  `dispense` int(3) DEFAULT '0',
  `volume` int(10) DEFAULT '0',
  `volume_units` int(10) DEFAULT '0',
  `quantity` int(10) DEFAULT '0',
  `strength` int(10) DEFAULT '0',
  `strength_units` int(10) DEFAULT '0',
  `rrp` float(10,2) DEFAULT '0.00',
  `shipping_cost` float(10,2) DEFAULT '0.00',
  `hide_product` tinyint(1) DEFAULT '1',
  PRIMARY KEY (`condition_product_id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

-- Dumping data for table jp.condition_product: 0 rows
/*!40000 ALTER TABLE `condition_product` DISABLE KEYS */;
/*!40000 ALTER TABLE `condition_product` ENABLE KEYS */;
...
CREATE TABLE IF NOT EXISTS `product` (
  ...
  `whole_sale_price` decimal(4,2) NOT NULL DEFAULT '0.00',
  `rrp` decimal(4,2) NOT NULL DEFAULT '0.00',
...
REPLACE INTO `sub_category` (`sub_category_id`, `date_created`, `date_modified`, `language_localisation`, `category_id`, `sub_category_name`, `sub_category_label`, `flag_hide`, `flag_delete`, `flag_featured`) VALUES
	...
	(12, '0000-00-00 00:00:00', '2012-08-13 14:10:44', 'en-GB', 2, 'Hairloss', 'Hairloss', 0, 0, 0),
