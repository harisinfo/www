...
<div id="container">
	...
	<div id="main">
		...
		<div id="content">
                        ...
                        <input type="hidden" name="update" value="price_list" />
                        <textarea name="price_list" id="price_list" style="margin-top:0px;">{$saloon.price_list.$saloon_id}</textarea>
                        </p>
                        <p>
                        <input type="submit" id="submit" name="submit" value="Update Price List" />
                        </form>
                        </p>
		</div>
	</div>
